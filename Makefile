...
CXXFLAGS=-levent -lzmq -lrt --sysroot=../../../../sw/firesim-software/buildroot/output/host/usr/riscv64-buildroot-linux-gnu/sysroot -pthread -O3 -Wall -g -std=c++11 -D_GNU_SOURCE
